<?
        ...
        $id = $_GET['perfil'];
       $select ="SELECT Foto,Nombre,Biografia,Likes,NPosts,Pais,Ciudad FROM Usuarios WHERE id= $id;";

        $user= mysqli_query($conbd,$select) or die("ERROR: datos no encontrados");
